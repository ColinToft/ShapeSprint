...
public class Drawable implements KeyListener, MouseListener {
	 ...
	 */
	public double pixelToPanelWidthFraction(int pixelX) {
		return (double) pixelX / panel.getWidth();
	}
	
	/**
	 * Converts a vertical value from screen coordinates (pixels) to a fraction of the panel height (0 to 1)
	 ...
	 */
	public double pixelToPanelHeightFraction(int pixelY) {
